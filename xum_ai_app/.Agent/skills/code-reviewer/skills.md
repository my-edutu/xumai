...
High-precision code review for the current project. Flag critical issues only. Leave inline comments tied to specific files and lines—no verbose summaries.
